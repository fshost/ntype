...
/**
 * @readonly
 * @enum {Object} an enumeration of native Object Class constructors
 * mapped from / to their string equivalents. Used internally as an
 * enumerator and exposed for the same purpose.
 * @example
 * // evaluates as true
 * ntype.type('foo') === ntype.Type[String];
 */
