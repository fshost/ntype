...
function classify(options, constructor) {
    ...
    if (options) {
        if (options instanceof Interface) {
            ...
            propagate = options.propagate !== undefined ? options.propagate : propagate;
            if (options.validateArgs !== undefined) {
                validateArgs = options.validateArgs;
                validateInstance = !validateArgs;
            }
            validateInstance = options.validateInstance !== undefined ? options.validateInstance : validateInstance;
        }
    ...
    function ClassWrapper(args) {
        var hasInterfaces = ClassWrapper.interfaces.length > 0;
